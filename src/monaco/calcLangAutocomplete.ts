...
export const functions: any[] = [
  ...
  },
  {
    label: "max",
    kind: functionKind,
    documentation: "Compute the maximum value of a matrix or a list with values",
    insertText: "max(${0})",
    insertTextRules: insertAsSnippet
  },
  {
    label: "mad",
    kind: functionKind,
    documentation: "Compute the median absolute deviation of a matrix or a list with values",
    insertText: "mad(${0})",
    insertTextRules: insertAsSnippet
  },
  {
...

  {
    label: "bignumber",
    kind: functionKind,
    documentation: "Create a BigNumber, which can store numbers with arbitrary precision",
  ...
  },
  {
    label: "boolean",
    kind: functionKind,
    documentation: "Create a boolean or convert a string or number to a boolean",
  ...
  },
  {
    label: "complex",
    kind: functionKind,
    documentation: "Create a complex value or convert a value to a complex value",
  ...
  },
  {
    label: "atan2",
    kind: functionKind,
    documentation: "Calculate the inverse tangent function with two arguments, y/x",
...
export let completionItemProvider: CompletionItemProvider = {
  provideCompletionItems: function(model: ITextModel, position: Position): ProviderResult<CompletionList> {
    return {
      suggestions: functions.concat(typeKeywords).concat(operators) as CompletionItem[]
    };
  }
};